...
$ID_Y=$_GET['GetID_Y'];
$query="select * from yard where ID_Y='".$ID_Y."'";
...
<section class="get-in-touch">
   <h1 class="title">Yard Edit</h1>
   <form class="contact-form row"  action="EditYardPro.php?ID_Y=<?php echo $ID_Y?>" method="post" enctype="multipart/form-data" autocomplete="off">
