...
<section class="get-in-touch">
   <h1 class="title">Exporter Management</h1>
   <form class="contact-form row" action="ProcessEporter.php" method="post">
      <div class="form-field col x-50">
         <input name="ICE" class="input-text js-input" type="text" required>
         <label class="label" for="first">ICE</label>
      </div>
             <div class="form-field col x-50">
      ...
      <div class="form-field col x-50">
         ...
         <label class="label" for="message">Place</label>
      </div>
