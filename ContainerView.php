...
<h1 class="th-la">Exporter View</h1>
                    <table class="table table-hover table-responsive mb-0">
                        <!--Table head-->
                        <thead>  
                            <tr>
                             <th class="th-lg">ID_E</th>
    ...
    while($row=mysqli_fetch_assoc($result)){
        ...
        ?>
        <tr>
        <th class="th-lg"><?php echo $ID_E ?></th>
        ...
        <th class="th-lg"><a href="ExporterEdit.php?GetID_E=<?php echo $ID_E?>">Edit</a></th>
        <th class="th-lg"><a href="DeleteExporter.php?Del=<?php echo $ID_E ?>">Delete</a></th>
        </tr>
       <?php 
    }
  ?>
