...
$ID_IM=$_GET['GetID_IM'];
$query="select * from importer where ID_IM='".$ID_IM."'";
...
<section class="get-in-touch">
   ...
   <form class="contact-form row" action="ProcessEditImporter.php?ID_IM=<?php echo $ID_IM ?>" method="post" enctype="multipart/form-data" autocomplete="off">
