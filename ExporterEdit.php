...
$ID_E=$_GET['GetID_E'];
$query="select * from exporter where ID_E='".$ID_E."'";
...
<section class="get-in-touch">
   ...
   <form class="contact-form row" action="ProcessEditExporter.php?ID_E=<?php echo $ID_E ?>" method="post" enctype="multipart/form-data" autocomplete="off">
       <div class="form-field col x-50">
         <input name="ICE" value="<?php echo $ICE ?>" class="input-text js-input" type="text" required>
         <label class="label" for="first">ICE <br/><br/></label>
      </div>
             <div class="form-field col x-50">
         <input  name="Name" value="<?php echo $Name ?>" class="input-text js-input" type="text" required>
         <label class="label" for="Last">Name <br/><br/></label>
      </div> 
      <div class="form-field col x-50">
         <input name="City" value="<?php echo $City ?>" class="input-text js-input" type="text" required>
         <label class="label" for="message">City <br/><br/></label>
      </div>
            <div class="form-field col x-50">
         <input name="Place" value="<?php echo $Place ?>" class="input-text js-input" type="text" required>
